...
export const FilterCard = ({ isActive, text, icon, onClick = () => {} }) => {
    ...
    return (
        <div 
            className={clsx(
                "w-full md:w-fit justify-between md:w-28 h-14 p-2 pr-3 rounded drop-shadow-md select-none flex flex-row items-center cursor-pointer transition-all duration-150",
        ...
        >
            ...
            <div className='rounded-full ml-2 md:ml-0 w-6 h-6'>
                {icon}
            </div>
        </div>
    )
